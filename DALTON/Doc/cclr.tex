...
\item[\Key{ATMMOM}] \verb| |\newline
   \verb|READ (LUCMD,*) IORATM|

Add atomic moment operators using MBIS (Minimum Basis Iterative Stockholder) population analysis to the operator lists.
The integer \verb|IORATM| sets the highest multipole order:
\begin{itemize}
