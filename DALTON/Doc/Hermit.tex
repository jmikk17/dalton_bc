...
Here \verb|MU_VALUE| is the value of $\mu$ used in separation of two-electron repulsion integrals in a short-range part and a long-range part using the error function:
\begin{eqnarray*}
Vee &=& Vlr+Vsr \\
