...
\item Property labels: \verb|GEFG abc |, where \verb|abc| is the number of the nuclear coordinate.
...
where $K$ is the nucleus of interest.
\item Property labels: \verb|LEFG abc |, where \verb|abc| is the number
