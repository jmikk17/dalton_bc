...
\item[\Key{GZZEFG}] Gradient of the electronic contribution to the $zz$ cartesian electric field integrals at nucleus \index{laplacian of cartesian electric
 field integrals}.
...
\item Property labels: \verb|GEFG abc |, where \verb|abc| is related to the nuclear coordinate number and the gradient component. \\
...
%$(1/2/3)$ times the symmetry-adapted nuclear coordinate of interest for the $(x/y/z)$ component of the gradient respectively.
\end{list}
...
\item[\Key{LAPEFG}] Laplacian of the electronic contribution to the cartesian electric field integrals at nucleus \index{laplacian of cartesian electric
 field integrals}.
...
where $K$ is the nucleus of interest.
\item Property labels: \verb|LEFG abc|, where \verb|abc| is related to the nuclear coordinate number and the laplacian component. There are nine integrals for each nucleus. \\
E.g.:
\begin{eqnarray*}
