...
\item[\Key{DIVEFG}] Divergence of the $zz$ cartesian electric field integrals at nucleus \index{laplacian of cartesian electric
 field integrals}.
...
\item Property labels: \verb|DEFG abc |, where \verb|abc| is the number
$(1/2/3)$ times the symmetry-adapted nuclear coordinate of interest for the $(x/y/z)$ component of the divergence.
\end{list}
...
\item[\Key{LAPEFG}] Laplacian of the cartesian electric field integrals at nucleus \index{laplacian of cartesian electric
 field integrals}.
