...
\item[\Key{MAXAPM}] \ \\
  ...
  maximum number orbital absorption steps\index{orbital absorption} within
  a macro iteration
...
\item[\Key{NEO ALWAYS}]
  Always usenorm-extended optimization (never switch to New\-ton-Raph\-son).
...
\item[\Key{OPTIMAL ORBITAL TRIAL VECTORS}]
  ...
  This will usually in cases where the configuration part is much more expensive
  than the orbital part save computer time in each MCSCF macro iteration.
