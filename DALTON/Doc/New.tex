...
\begin{description}
 ...
 \item Population anlysis for all MCSCF and CI wave functions. (H. J. Aa. Jensen)
 \item CI with PElib (polarizable embedding or polarizable density embedding. (H. J. Aa. Jensen)
 \item EKT, i.e. ionization potentials using the extended Koopmans' theorem for MCSCF and MC-srDFT. Is always activated for these types of wave functions. (Martin J. R. Jensen and H. J. Aa. Jensen)
 ...
 \item SOPPA
  \begin{itemize}
   \item Block Lanczos RPA eigenvalue solver for computing mean excitation energy and the dipole oscillator strength sums in Lanczos basis at RPA level. The solver is a part of AO-SOPPA and its driver is called from ABACUS driver (Luna Zamok)
   \item Added PE-AO-SOPPA/RPA (Peter Reinholdt)
   \item First terms of the TOPPA A-matrix implemented: terms involving the second order doubles correlation coeffiients (Javier Sanz Rodrigo & Stephan P. A. Sauer)
  \end{itemize}
 \item Atomic Integrals (Juanjo Aucar)
  ...
  \end{itemize}
 \item LRESC (Juanjo Aucar)
  \begin{itemize}
   \item Implementation for the Electric Field Gradient at first order in 1/c2
 ...
 \item Print two effective numbers of unpaired electrons in final wave function output (H. J. Aa. Jensen)
  \begin{itemize}
   \item 1) sum(i)  n\_i (2 - n\_i)
   \item 2) sum(i) (n\_i (2 - n\_i))**2
  \end{itemize}
 \item Analysis of SSCCs in terms of localized orbitals \\
 ...
 \item PDE-London: Added implementation of London orbitals, aka gauge-including atomic orbitals (GIAO), for PDE \\ {}
  [ Reference: F. J. Kamper, P. Reinholdt, E. D. Hedegård, and J. Kongsted, J. Chem. Theory Comput. 18, 7384-7393 (2022), https://doi.org/10.1021/acs.jctc.2c00829 ].
 \item Polarizable embedding (PE) with periodic boundary conditions (PBC)
  [ Reference: S. Kvedaraviciute, D. Carrasco-Busturia, K. B. Møller, and J. M. H. Olsen, ChemRxiv, (2022), https://doi.org/10.26434/chemrxiv-2023-fc0gk ].
