...
%Dalton2020.0 
\latestrelease\
program suite is distributed through git obtainable from the Dalton
repository at https://gitlab.com/dalton/dalton. After you have downloaded the source files with:
\begin{verbatim}
