...
Help and support from the Dalton community is available at \url{https://gitlab.com/dalton/user-support}.
...
The current release of the program supports Linux\index{Linux}, Cray\index{Cray},
and MacOS\index{MacOSX} using GNU or Intel compilers.
We have not tested NVIDIA HPC and IBM XL comppilers (2024).
