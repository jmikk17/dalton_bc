...
!cx         jja  : edited on February 2023 to add and modify variables for shielding
      REAL*8 calfa, CFCZK, CFCDE, CSDK, CSDD, CSDBS, CPSOK,
     ...
     &            CSDK=-0.375D0, CSDD=1/4.D0,
     &            CFCBS=0.25D0, CSDBS=0.25D0, 
     &            CPSOK=-0.125D0, COZK=-1.0D0, CDIAM=1.0D0, 
     &            CDIAD=1.0D0, CDIAK=1/8.0, CANGP=-0.25D0,
     &            CFCAV=-7.0/16.0, CSDAV=-1.0/8.0, CPSOOZMV=-0.5D0,
     &            CPSOOZDW=-0.5D0, COZFCSO=-0.5D0, COZSDSO=-0.25D0, 
     &            CEFGDW=-1.0D0, CEFGMV=-1.0D0, CEFGpqp=0.25D0, 
     &            CEFGkin=-0.5D0, CEFGlap=1.0/8.0)
    ...
    !LRESC corrections to shielding
     ...
     &         PRTALL1, LRATOM_changed, LRANISO
    ...
    !LRESC corrections to EFG and common logicals
     ...
     &    LRPSOK, LRPSKI, LRFCZK, LRFCDE, LRSDK, LRSDD,
     &    LRFCBS, LRSDBS, SLRESC, SGD0S, 
