...
!cx         jja  : edited on February 2023 to add and modify variables for shielding
    ...
    !LRESC corrections to shielding
     ...
     &         PYINTS, EXTRAINFO, WARNLRS, WARNLRT, WARNQR, LRINTS

    !LRESC corrections to EFG and common logicals
      LOGICAL ORBCON,PQPKINLRESC,PRTALL2,EFGC2FLAG,EFGC4FLAG

      DOUBLE PRECISION LRFCAV(3,3), LRFCAVpy(3,3), LRDIAK(3,3),
     &      LRANGP(3,3),LRANGPavg(3,3),
     ...
     &    EXTRAINFO, WARNLRS, WARNLRT, WARNQR, LRINTS,
     &    EFGC2FLAG, EFGC4FLAG, EFGC4, EFGTIME,NLRATOMS
! -- end of lrescinf.h --
