...
C     MP2_SCALEFAC(1) = 2.0d0 ! p_s+p_T, scale factor on (ia|jb)**2
C     MP2_SCALEFAC(2) =-1.0d0 !    -p_T, scale factor on (ia|jb)*(ib|ja)
C     MP2_SCALED    = .FALSE. ! true if MP2_SCALEFAC .ne. 1, 1
...
C     THRP_MP2                ! threshold for neglect of two-electron MO integrals
C
C     DCPT2       : degeneracy corrected PT2
C     SAVE_MP2WF1 : calculate and save MP2 coefficients on SIRIFC
C
      REAL*8  MP2_SCALEFAC, MP2_LSHIFT, LAMSR, THRP_MP2
      INTEGER IPRMP2, NFRMP2, NPHSYM, NPHMAX, NP, NH,
     &        IPHORD, INDXPH, IFRMP2, NPHTOT
      LOGICAL MP2FRO, MP2_SOS, MP2_SCS, MP2_TDA, MP2_NO_OCCVIR,
     &        MP2_SCALED, SRMP2_SELFCONSISTENT, SRMP2_SRINTS,
     &        DCPT2, DO_RSDHF, SAVE_MP2WF1, MP2_ASSIGN
      COMMON /INFMP2/ MP2_SCALEFAC(2), MP2_LSHIFT, LAMSR, THRP_MP2,
