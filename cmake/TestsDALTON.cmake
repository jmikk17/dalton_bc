...
add_dalton_runtest(dft_ac_multpole               "dalton;runtest;dft;long")
...
add_dalton_runtest(dft_camb3lyp_molgrad          "dalton;runtest;dft;short;essential")
...
add_dalton_runtest(dft_disp_d3bj                 "dalton;runtest;dft;short;essential")
...
add_dalton_test(walk_gradex                      "dalton;walk;essential")
...
if(ENABLE_GEN1INT)
    ...
    add_dalton_runtest(hf_cube                   "dalton;runtest;gen1int;essential")
endif()

add_dalton_runtest(energy_fcktra                 "dalton;runtest;energy;mcscf;short;essential")
add_dalton_runtest(energy_restart                "dalton;runtest;energy;mcscf;multistep;short")
add_dalton_runtest(energy_restart_scf            "dalton;runtest;energy;multistep;short;essential")
add_dalton_runtest(energy_symm                   "dalton;runtest;energy;mcscf;short;essential")
add_dalton_runtest(energy_nosymm                 "dalton;runtest;energy;mcscf;short")
...
add_dalton_runtest(energy_corehole               "dalton;runtest;energy;mcscf;multistep;short")
...
add_dalton_test(energy_nevpt2_gs                 "dalton;energy;mcscf;short;essential")
add_dalton_test(energy_nevpt2_ex                 "dalton;energy;mcscf;medium")
...
add_dalton_test(energy_solv                      "dalton;energy;mcscf;medium")
...
add_dalton_runtest(prop_spinspin1                "dalton;serial;runtest;mcscf;prop;short")
add_dalton_runtest(prop_spinspin2                "dalton;serial;runtest;mcscf;prop;short")
add_dalton_runtest(prop_spinspin3                "dalton;serial;runtest;mcscf;prop;short")
...
add_dalton_runtest(prop_newtramcscf              "dalton;serial;runtest;mcscf;prop;short")
add_dalton_runtest(prop_vibg1                    "dalton;serial;runtest;mcscf;prop;short;essential")
add_dalton_runtest(prop_vibg2                    "dalton;serial;runtest;mcscf;prop;short;essential")
add_dalton_runtest(prop_cpp_ecd                  "dalton;runtest;prop;short")
add_dalton_runtest(prop_lresc_shielding          "dalton;runtest;prop;short;essential")
add_dalton_runtest(prop_lresc_efg                "dalton;runtest;prop;short;essential")
...
add_dalton_runtest(prop_spinspin_aotoppa         "dalton;runtest;prop;aosoppa;verylong")

add_dalton_runtest(prop_vibana                   "dalton;runtest;prop;long")
add_dalton_runtest(prop_expgrad                  "dalton;runtest;prop;dft;short")
add_dalton_runtest(prop_nucquad                  "dalton;serial;runtest;mcscf;prop;short")
...
add_dalton_runtest(rsp_2ndharm                   "dalton;serial;runtest;mcscf;rsp;short;essential")
add_dalton_runtest(rsp_3rdharm                   "dalton;serial;runtest;mcscf;rsp;short;essential")
...
if(ENABLE_PELIB)
    ...
    add_dalton_runtest(peaosoppa_excit               "dalton;serial;pelib;runtest;short")
    ...
    add_dalton_runtest(pehf_mic                      "dalton;pelib;runtest;short")
...
# pcm_soppa_excit gives wrong excitation energies in parallel
...
# some srdft tests
    ...
    add_dalton_runtest(rsp_srdft_fermi                      "dalton;srdft;rsp;runtest;parallel;essential")
    add_dalton_runtest(rsp_srdft_fermi_medium               "dalton;srdft;rsp;runtest;parallel;medium")
    add_dalton_runtest(rsp_srdft_triplet_not_essential      "dalton;srdft;rsp;runtest;parallel;medium")
    add_dalton_runtest(rsp_srdft_singlet_not_essential      "dalton;srdft;rsp;runtest;parallel;medium")
    add_dalton_runtest(rsp_srdft_fermi_not_essential        "dalton;srdft;rsp;runtest;parallel;medium")
